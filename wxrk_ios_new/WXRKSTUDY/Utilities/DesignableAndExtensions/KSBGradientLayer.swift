//
//  KSBGradientLayer.swift
//  WXRKSTUDY
//
//  Created by KaramjeetSingh on 30/07/22.
//

import UIKit
class KSBGradientLayer: UIView {
    private lazy var pulse: CAGradientLayer = {
        let l = CAGradientLayer()
        l.type = .radial
        l.colors = [ UIColor.init(red: 1.0/255.0, green: 16.0/255/0, blue: 39.0/255/0, alpha: 1),
                     UIColor.init(red: 6.0/255.0, green: 62.0/255/0, blue: 113.0/255/0, alpha: 1),]
        l.locations = [ 0,0.7]
...
@objc public enum KSBCircularProgressGlowMode: Int {
    case forward, reverse, constant, noGlow
}

@IBDesignable
@objcMembers
public class KSBCircularProgress: UIView, CAAnimationDelegate {
    private var progressLayer: KSBCircularProgressViewLayer {
        get {
            return layer as! KSBCircularProgressViewLayer
        }
    }
    ...
    public var glowMode: KSBCircularProgressGlowMode = .forward {
        didSet {
    ...
    override public class var layerClass: AnyClass {
        return KSBCircularProgressViewLayer.self
    }
    ...
    public func animate(fromAngle: Double, toAngle: Double, duration: TimeInterval, relativeDuration: Bool = true, completion: ((Bool) -> Void)?) {
        ...
        let animation = CABasicAnimation(keyPath: #keyPath(KSBCircularProgressViewLayer.angle))
    ...
    private class KSBCircularProgressViewLayer: CALayer {
        ...
        var glowMode: KSBCircularProgressGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: KSBCircularProgressGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
        ...
        override init(layer: Any) {
            ...
            let progressLayer = layer as! KSBCircularProgressViewLayer
